...
The ten topics and the corresponding material are as follows:
 ...
 2. **Non-negative Matrix Factorization** [material](#Nonnegative-Matrix-Factorization) [slides](./course_files/lecture_slides/NMF.pdf)
  3. **Matrix Completion** [material](#Matrix-Completion)
  4. **Sparse Coding**
  5. **Sparse Sensing**
...
- [PMF library](http://www.cs.toronto.edu/~rsalakhu/BPMF.html) is a library for probabilistic matrix factorization by Ruslan Salakhutdinov with matlab, which is also the most common optimization objective.
